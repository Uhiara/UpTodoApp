...
fun OnBoardingScreen3(
    ...
    Surface(
        ...
        Column(
            ...
            ImageComponent(imageValue = R.drawable.onboarding3)
            ...
            TextComponent(
                modifier = Modifier.padding(start = 12.dp, end = 12.dp),
                textValue = "You can organize your daily tasks by adding your tasks into separate categories",
                textSize = 16.sp,
